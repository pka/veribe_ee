    ...
    def run(self):
        ...
        if not project_id:
            self.iface.messageBar().pushMessage(
                "Error", _translate("VeriSO_EE_BB_Minimalflaechen",
        ...
        try:
            ...
            layer["type"] = "postgres"
            layer["title"] = _translate("VeriSO_EE_BB_Minimalflaechen",
                                        "BB-Flächen TS1/TS2 kleiner 100qm", None)
            layer["readonly"] = True
            layer["featuretype"] = "z_v_bb_ts"
            layer["geom"] = "geometrie"
            layer["key"] = "ogc_fid"
            ...
            QMessageBox.information(
                None, "Surfaces plus petites que criteres de surface",
