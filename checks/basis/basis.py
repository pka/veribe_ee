    ...
    def run(self):
        ...
        if not project_id:
            self.iface.messageBar().pushMessage(
                "Error",
                _translate("VeriSO_EE_basis", "project_id not set", None),
        ...
        try:
            ...
            layer = {}
            layer["type"] = "postgres"
            layer["title"] = _translate("VeriSO_EE_basis",
            ...
            layer["type"] = "postgres"
            layer["title"] = _translate("VeriSO_EE_basis",
                                        "Hoheitsgrenzpunkt - unversichert",
                                        None)
            layer["readonly"] = True
            ...
            layer["title"] = _translate("VeriSO_EE_basis", "Nr Gs(LS-Teil)",
                                        None)
            layer["readonly"] = True
            layer["featuretype"] = "z_nr_gs"
            layer["geom"] = "pos"
