    ...
    def run(self):
        ...
        if not project_id:
            self.iface.messageBar().pushMessage(
                "Error",
                _translate("VeriSO_EE_PNF", "project_id not set", None),
        ...
        try:
            ...
            layer = {
                "type": "postgres",
                "title": _translate("VeriSO_EE_basis", "Bodenbedeckung Umriss",
                                    None),
                "readonly": True,
            ...
            layer = {
                'type': 'wms',
                'title': _translate('VeriSO_EE_PNF', 'AV Bodenbedeckung',
                                    None),
                'url': 'http://www.geoservice.apps.be.ch/geoservice2/services/a42geo/a42geo_avrwms_d_fk/MapServer/WMSServer?',
